...
const Tabs: React.FC<TabsProps> = ({ repoCount, starredCount }) => {
  ...
  return (
    <div className="flex w-full border-b border-gray-200 text-sm md:text-base lg:text-xl">
      <div
      ...
      >
        <GoRepo size={22} className={`flex-shrink-0 ${activeTab === 'repositories' ? "text-black" : "text-gray-400"}` } />
      ...
      >
        <GoStar size={22} className={`flex-shrink-0 ${activeTab === 'starred' ? "text-black" : "text-gray-400"}`} />
